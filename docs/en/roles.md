...
| **CLIENT + BLE**       | `RIVR_ROLE_CLIENT=1` + `RIVR_FEATURE_BLE=1` | `client_<board>_ble` | Same as CLIENT plus BLE bridge |
...
| BLE bridge (`RIVR_FEATURE_BLE`) | ✅ in `_ble` envs | Bluedroid Nordic NUS GATT bridge; disabled by default |
