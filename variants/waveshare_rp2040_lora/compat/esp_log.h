/**
 * @file  variants/waveshare_rp2040_lora/compat/esp_log.h
 * @brief Shim replacing ESP-IDF esp_log.h for RP2040 Arduino builds.
 *
 ...
 * those files compile unchanged on RP2040.
 *
 * Output goes to Arduino Serial (initialized in setup() in main_rp2040.cpp).
...
/* ESP_ERROR_CHECK — on RP2040 just assert */
