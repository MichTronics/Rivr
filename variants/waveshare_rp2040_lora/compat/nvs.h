/**
 * @file  variants/waveshare_rp2040_lora/compat/nvs.h
 ...
 *
 * The RP2040 has no ESP-IDF NVS partition.  Persistent identity storage
 * may be added later using LittleFS or similar, but for the initial
 * port the compile-time defaults (RIVR_CALLSIGN, RIVR_NET_ID) are always used.
 */
